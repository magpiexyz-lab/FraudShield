...
# CI-ONLY: python3 scripts/ci-check-graduation-atomicity.py, bash .claude/scripts/stack-knowledge-audit.sh, python3 scripts/print-stack-knowledge-files.py, python3 scripts/lint-verification-snippets.py
