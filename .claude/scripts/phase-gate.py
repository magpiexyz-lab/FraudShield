...
def check_completed_states(skill, required_states, errors):
    ...
    ctx_file = '.claude/verify-context.json' if skill == 'verify' else f'.claude/{skill}-context.json'
...
def check_plan_fields(fields, errors):
    ...
    plan_path = '.claude/current-plan.md'
...
def check_q_score(skill, min_score, errors):
    ...
    history_path = '.claude/verify-history.jsonl'
